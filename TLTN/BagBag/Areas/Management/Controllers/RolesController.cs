...
namespace BagBag.Areas.Management.Controllers
{
    public class RolesController : BaseController
    {
        ...
        // GET: Management/Roles/Details/5
        ...
        // GET: Management/Roles/Create
        public ActionResult Create()
        {
            return View();
        }

        // POST: Management/Roles/Create
        ...
        // POST: Management/Roles/Delete/5
