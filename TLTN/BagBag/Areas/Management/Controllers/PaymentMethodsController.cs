...
namespace BagBag.Areas.Management.Controllers
{
    public class PaymentMethodsController : BaseController
    {
        ...
        // GET: Management/PaymentMethods
        public ActionResult Index()
        {
            return View(db.PaymentMethods.ToList());
        }

        // GET: Management/PaymentMethods/Details/5
        ...
        // GET: Management/PaymentMethods/Create
        public ActionResult Create()
        {
            return View();
        }

        // POST: Management/PaymentMethods/Create
        ...
        // GET: Management/PaymentMethods/Edit/5
        ...
        // POST: Management/PaymentMethods/Edit/5
        // To protect from overposting attacks, please enable the specific properties you want to bind to, for 
        // more details see https://go.microsoft.com/fwlink/?LinkId=317598.
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "PaymentId,PaymentName")] PaymentMethod paymentMethod)
        {
            if (ModelState.IsValid)
            {
        ...
        // GET: Management/PaymentMethods/Delete/5
        ...
        // POST: Management/PaymentMethods/Delete/5
