...
namespace BagBag.Areas.Management.Controllers
{
    public class ProductsController : BaseController
    {
        ...
        public ActionResult Create([Bind(Include = "ProductId,ProductName,ProductDetails,ProductStatus,ProductUpdate,ProductQty,ProductSold,SupplierId,CategoryId,LinkPay")] Product product)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "ProductId,ProductName,ProductDetails,ProductStatus,ProductUpdate,ProductQty,ProductSold,SupplierId,CategoryId,PromotionId,LinkPay")] Product product)
        {
            if (ModelState.IsValid)
            {
                try
