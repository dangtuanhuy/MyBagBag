...
namespace BagBag.Areas.Management.Controllers
{
    public class ProductsController : BaseController
    {
        ...
        public ActionResult Create([Bind(Include = "ProductId,ProductName,ProductDetails,ProductStatus,ProductUpdate,ProductQty,ProductSold,SupplierId,CategoryId,LinkPay,Style")] Product product)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "ProductId,ProductName,ProductDetails,ProductStatus,ProductUpdate,ProductQty,ProductSold,SupplierId,CategoryId,PromotionId,LinkPay,Style")] Product product)
        {
            if (ModelState.IsValid)
            {
                try
